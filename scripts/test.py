...
def run_package_analysis(package_name, package_ecosystem):
    cmd = ['/home/kali/thesis/thesis/package-analysis/scripts/run_analysis.sh', '-ecosystem', package_ecosystem, '-package', package_name]
    ...
    if proc.returncode == 0:
        ...
        print("[!] Error in {} (returncode={})".format(package_name, proc.returncode))
        if stderr:
